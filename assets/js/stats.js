var Stats = function () {
  ...
  (d.id = "fpsText"),
    (d.style.cssText =
      "color:#0ff;font-family:Comic Sans MS;font-size:9px;font-weight:bold;line-height:15px"),
    (d.innerHTML = "FPS"),
    u.appendChild(d);
  ...
  (g.id = "msText"),
    (g.style.cssText =
      "color:#0f0;font-family:Comic Sans MS;font-size:9px;font-weight:bold;line-height:15px"),
    (g.innerHTML = "MS"),
    m.appendChild(g);
